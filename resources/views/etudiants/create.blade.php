                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('etudiants.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nom_etude" type="text" class="form-control @error('nom_etude') is-invalid @enderror" name="nom_etude" value="{{ old('nom_etude') }}" required>
                                @error('nom_etude')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="prenom_etud" type="text" class="form-control @error('prenom_etud') is-invalid @enderror" name="prenom_etud" value="{{ old('prenom_etud') }}" required>
                                @error('prenom_etud')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel_etud" type="text" class="form-control @error('tel_etud') is-invalid @enderror" name="tel_etud" value="{{ old('tel_etud') }}" required>
                                @error('tel_etud')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adress_etud" type="text" class="form-control @error('adress_etud') is-invalid @enderror" name="adress_etud" value="{{ old('adress_etud') }}" required>
                                @error('adress_etud')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ville_etud" type="text" class="form-control @error('ville_etud') is-invalid @enderror" name="ville_etud" value="{{ old('ville_etud') }}" required>
                                @error('ville_etud')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="commune_etud" value="{{ old('commune_etud') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date_naiss_etud" type="date" class="form-control @error('date_naiss_etud') is-invalid @enderror" name="date_naiss_etud" value="{{ old('date_naiss_etud') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="niveau_formation_etud" type="number" class="form-control @error('niveau_formation_etud') is-invalid @enderror" name="niveau_formation_etud" value="{{ old('niveau_formation_etud') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="filiere_etud" id="filiere_etud" value="{{ old('filiere_etud') }}" required>
                                    <optgroup label="BTS">
